...
# Read data
df_raw <- read.csv("C:\\Users\\Mohamad Hafiz\\Documents\\Data Science 2Y2S\\Assignment\\Unclean Dataset.csv", header = TRUE, stringsAsFactors = FALSE)
...
write_xlsx(df_clean, "C:\\Users\\Mohamad Hafiz\\Documents\\Data Science 2Y2S\\Assignment\\Cleaned_Data.xlsx")
# Check structure
str(df_clean)